...
function writeTexts(texts) {
  ...
  for (let i = 0; i < texts.length; i++) {
    ...
    $musicContainer.children[i].children[0].children[0].src =
      curObject.embedcode;
    $musicContainer.children[i].children[1].children[0].innerText =
      curObject.titel;
    $musicContainer.children[i].children[1].children[1].innerText =
      curObject.beschrijving;
    $musicContainer.children[i].children[1].children[2].href =
      curObject.streamlink;
    $musicContainer.children[i].children[1].children[2].innerText =
      curObject.stream;
  }
}
